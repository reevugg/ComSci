...
// Check if the 'sort' and 'order' query parameters are set
...
// Validate the sorting order to prevent SQL injection
$validOrders = ['asc', 'desc'];
if (!in_array($order, $validOrders)) {
    $order = 'asc';
}

// Prepare the SQL query to select all records from the View_order table with sorting
